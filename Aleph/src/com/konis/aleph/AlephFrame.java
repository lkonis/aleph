...
public class AlephFrame extends JFrame implements ActionListener {
	...
	public AlephFrame() throws IOException {
		...
		String path_to_input = "/home/ubtosh/workspace/data/input.txt";
...
/*				if (soundOff)
	...
	public void dealStaticVowelLabel(int containingPanelWidthLimits, int i,
		...
		if (vowel_are_not_placed) {
			...
			r1.height = vowelSize;
			r1.width = vowelSize;
			JLabel vw_lb = placeVowels(vowelSize, r1);
	 ...
	 */
	private JLabel placeVowels(int vowelSize, Rectangle r) {
